    ...
    return function (shipping) {
        return shipping.extend({
            ...
            getValue: function () {
                ...
                return this.getFormattedPrice(price); // formattedpPrice chèn thêm VND, $, v...
            },
            ...
            getShippingMethodTitle: function () {
                ...
                price = ' - ' + this.getFormattedPrice(shippingMethod.amount);

                if (typeof shippingMethod['method_title'] !== 'undefined') {
                    shippingMethodTitle = shippingMethod['method_title'];
                }

                return shippingMethod ? shippingMethodTitle + price : '';
            },
        });
    }
});
