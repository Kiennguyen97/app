 ...
 */
namespace AHT\G1T563\ViewModel\Product;
...
class Breadcrumbs extends DataObject implements ArgumentInterface
{
    ...
    {
        return $this->scopeConfig->getValue('helloworld/general/pagetitle', \Magento\Store\Model\ScopeInterface::SCOPE_STORE) !== null
            ? $this->scopeConfig->getValue('helloworld/general/pagetitle', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)
            : self::DEFAULT_TITLE;
    }
