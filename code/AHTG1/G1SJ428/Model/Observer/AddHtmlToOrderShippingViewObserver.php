...
class AddHtmlToOrderShippingViewObserver implements ObserverInterface
{
    ...
    public function execute(EventObserver $observer)
    {
        if($observer->getElementName() == 'order_shipping_view')
        {
            ...
            $deliveryDateBlock->setCustomText($order->getCustomText());
            // $deliveryDateBlock->setOrderComment($order->getOrderComment());
            $deliveryDateBlock->setTemplate('AHTG1_G1SJ428::order_info_shipping_info.phtml');
