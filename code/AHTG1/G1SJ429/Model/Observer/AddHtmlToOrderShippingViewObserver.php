...
namespace AHTG1\G1SJ429\Model\Observer;
...
class AddHtmlToOrderShippingViewObserver implements ObserverInterface
{
    ...
    public function execute(EventObserver $observer)
    {
        if($observer->getElementName() == 'order_shipping_view')
        {
            ...
            $orderCommentBlock->setOrderComment($order->getOrderComment());
            $orderCommentBlock->setTemplate('AHTG1_G1SJ429::order_info_shipping_info.phtml');
